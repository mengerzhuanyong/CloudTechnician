...
export default class PopModel extends Component {
    ...
    componentDidMount(){
        let url = NetApi.getPoupContent;
        this.netRequest.fetchGet(url)
            .then(result => {
                if (result && result.code === 1) {
                    this.setState({
                        poupContentText: result.data,
                    })
                }
            })
    }
                    ...
                    <TouchableHighlight style={styles.modalStyle} onPress={() => this.modalVisible()}>
                        <View style={[styles.subView, style]}>
                            <View style={[styles.contentView]}>
                                ...
                                <Text style={[styles.contentText]}>{poupContentText[0]}</Text>
                                <View style={styles.textIconView}>
                                    <Image source={GlobalIcons.icon_diamond} style={[styles.shopTagsIcon, styles.diamondIcon]} />
                                    <Image source={GlobalIcons.icon_diamond} style={[styles.shopTagsIcon, styles.diamondIcon]} />
                                </View>
                                <Text style={[styles.contentText]}>{poupContentText[1]}</Text>
                                <View style={styles.textIconView}>
                                    <Image source={GlobalIcons.icon_diamond} style={[styles.shopTagsIcon, styles.diamondIcon]} />
                                    <Image source={GlobalIcons.icon_diamond} style={[styles.shopTagsIcon, styles.diamondIcon]} />
                                    <Image source={GlobalIcons.icon_diamond} style={[styles.shopTagsIcon, styles.diamondIcon]} />
                                </View>
                                <Text style={[styles.contentText]}>{poupContentText[2]}</Text>
                                <View style={styles.textIconView}>
                                    <Image source={GlobalIcons.icon_diamond} style={[styles.shopTagsIcon, styles.diamondIcon]} />
                                    <Image source={GlobalIcons.icon_diamond} style={[styles.shopTagsIcon, styles.diamondIcon]} />
                                    <Image source={GlobalIcons.icon_diamond} style={[styles.shopTagsIcon, styles.diamondIcon]} />
                                ...
                                <Text style={[styles.contentText]}>{poupContentText[3]}</Text>
                                <View style={styles.textIconView}>
                                    <Image source={GlobalIcons.icon_excellent} style={[styles.shopTagsIcon]} />
                                </View>
                                <Text style={[styles.contentText]}>{poupContentText[4]}</Text>
                            </View>
