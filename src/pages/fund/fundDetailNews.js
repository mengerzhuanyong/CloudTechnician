...
export default class FundDetailNews extends Component {
    ...
    renderCompanyItem = ({item}) => {
        ...
        return (
            <TouchableOpacity onPress={() => {this.toWebview(item.title, item.id, url, 'NewsWebDetail')}} style={[styles.gonggaoList, GlobalStyle.flexRowStart]}>
