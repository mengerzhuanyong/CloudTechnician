...
export default class TuijianBangka extends Component {
    constructor(props) {
        super(props);
    ...
    loadNetData = () => {
        let url = NetApi.get_team_bind_card_list;
        let data = {
                ...
                <TouchableOpacity onPress={() => {RouterHelper.navigate('', 'OrderRenshengouDetail', item.order_id)}} style={styles.orderTop}>
                    <View style={[styles.orderInfo, GlobalStyle.flexRowBetween]}>
                        <View style={[styles.orderCreate, GlobalStyle.flexRowStart]}>
                            ...
                            <Text style={styles.orderCreateText}>{item.account}({item.truename})</Text>
                        </View>
                        <Text style={styles.orderStatus}>{item.bind_day}</Text>
                    </View>
                </TouchableOpacity>
            </View>
        )
