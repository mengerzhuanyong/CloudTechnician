 ...
 * 进行中界面
 */
export default class OnProcess extends Component {
    ...
    renderCompanyItem = ({item}) => {
        let id=item.id;
        return (
            <TouchableOpacity style={{backgroundColor:'#fff',padding:15,marginTop:10}}   onPress={() => {this.toPage(1,id,'OrderDetail')}}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <View style={{}}>
                        <TouchableOpacity >
                            <Text style={{textAlign:'center',paddingTop:5,paddingBottom:5,paddingLeft:8,paddingRight:8,backgroundColor:'#fff', color:'#5c7091'}}>服务中</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => {this.finishOrder(item)}}>
                            <Text style={{textAlign:'center',backgroundColor:'#5c7091',paddingTop:5,paddingBottom:5,paddingLeft:8,paddingRight:8,borderWidth:1,borderRadius:5,borderColor:'#5c7091', color:'#fff',marginTop:5}}>完   成</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                {/*</View>*/}
